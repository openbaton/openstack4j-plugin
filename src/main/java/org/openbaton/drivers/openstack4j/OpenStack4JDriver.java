...
//        }
    ...
    public OSClientV3 authenticate(VimInstance vimInstance){
        return OSFactory.builderV3()
                ...
                .credentials(vimInstance.getUsername(), vimInstance.getPassword(), Identifier.byName("Default"))
    ...
    public static void main(String[] args) throws
        ...
        if (args.length == 6) {
            PluginStarter.registerPlugin(OpenStack4JDriver.class,
                    args[0],
                    args[1],
    ...
    @Override
    public Server launchInstanceAndWait(VimInstance vimInstance, String hostname, String image, String extId, String keyPair, Set<String> networks, Set<String> securityGroups, String s, Map<String, String> floatingIps, Set<Key> keys) throws VimDriverException {
        return null;
    }
